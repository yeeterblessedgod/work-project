/**
 * ============================================================================
 *  catalog.js — каталог YourProjectName
 *  Роли:
...
function setupUI() {
  ...
  if (greeting) {
    greeting.textContent = `Здравствуйте, ${currentUser.fullName || currentUser.login}! `;
  }
      ...
      return `
        <article class="product-card" data-id="${p.id}">
          ...
          <div class="product-meta">
            Категория: ${escapeHtml(p.category)} · Остаток: ${p.stock}<br>
            Опубликовано: ${p.publishedAt}
          </div>
